...
class Structure():
  ...
  def save_structures(self, path=''):
    pickle_out = open(os.path.join(path, 'TrainStructures.pickle'), 'wb')
    pickle.dump(self.TrainStructures, pickle_out)
    pickle_out.close()
    pickle_out = open(os.path.join(path, 'ValStructures.pickle'), 'wb')
    pickle.dump(self.ValStructures, pickle_out)
    pickle_out.close()

  def load_structures(self, path=''):
    pickle_in = open(os.path.join(path, 'TrainStructures.pickle'), 'rb')
    self.TrainStructures = pickle.load(pickle_in)
    pickle_in.close()
    pickle_in = open(os.path.join(path, 'ValStructures.pickle'), 'rb')
    self.ValStructures = pickle.load(pickle_in)
    pickle_in.close()
